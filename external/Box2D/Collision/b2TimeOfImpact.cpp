...
qreal b2_toiTime, b2_toiMaxTime;
...
struct b2SeparationFunction
{
	...
	//
	qreal FindMinSeparation(int32* indexA, int32* indexB, float32 t) const
	{
		b2Transform xfA, xfB;
	...
	//
	qreal Evaluate(int32 indexA, int32 indexB, float32 t) const
	{
		b2Transform xfA, xfB;
		m_sweepA.GetTransform(&xfA, t);
		m_sweepB.GetTransform(&xfB, t);
...
void b2TimeOfImpact(b2TOIOutput* output, const b2TOIInput* input)
{
	...
	qreal target = b2Max(b2_linearSlop, totalRadius - 3.0 * b2_linearSlop);
	...
	qreal time = timer.GetMilliseconds();
