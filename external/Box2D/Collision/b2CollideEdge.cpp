						   ...
						   const b2PolygonShape* polygonB, const b2Transform& xfB)
{
	...
	qreal offset1 = b2Dot(m_normal1, m_centroidB - m_v1);
	qreal offset0 = 0.0f, offset2 = 0.0f;
	...
	if (primaryAxis.type == b2EPAxis::e_edgeA)
	{
		...
		int32 bestIndex = 0;
		qreal bestValue = b2Dot(m_normal, m_polygonB.normals[0]);
		for (int32 i = 1; i < m_polygonB.count; ++i)
		{
			qreal value = b2Dot(m_normal, m_polygonB.normals[i]);
			if (value < bestValue)
			{
				bestValue = value;
				bestIndex = i;
...
b2EPAxis b2EPCollider::ComputeEdgeSeparation()
{
	...
	{
		qreal s = b2Dot(m_normal, m_polygonB.vertices[i] - m_v1);
...
b2EPAxis b2EPCollider::ComputePolygonSeparation()
{
	...
	for (int32 i = 0; i < m_polygonB.count; ++i)
	{
		...
		qreal s1 = b2Dot(n, m_polygonB.vertices[i] - m_v1);
		qreal s2 = b2Dot(n, m_polygonB.vertices[i] - m_v2);
		qreal s = b2Min(s1, s2);
