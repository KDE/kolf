...
void b2RevoluteJoint::InitVelocityConstraints(const b2SolverData& data)
{
	...
	{
		qreal jointAngle = aB - aA - m_referenceAngle;
...
bool b2RevoluteJoint::SolvePositionConstraints(const b2SolverData& data)
{
	...
	if (m_enableLimit && m_limitState != e_inactiveLimit && fixedRotation == false)
	{
		qreal angle = aB - aA - m_referenceAngle;
...
qreal b2RevoluteJoint::GetReactionTorque(float32 inv_dt) const
{
...
qreal b2RevoluteJoint::GetMotorTorque(float32 inv_dt) const
{
...
void b2RevoluteJoint::SetLimits(qreal lower, float32 upper)
{
